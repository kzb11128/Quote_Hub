...
const generatedQuoteAuthorElement = document.querySelector(
  "#random-quote-author"
);
  ...
  try {
    ...
    if (response.ok) {
      ...
      savedQuoteElement.innerHTML = `
        <div class="mb-5 block rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
          <h5 class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50" style="font-family:  'Libre Baskerville', serif;">
            ${savedQuoteData.author}
          </h5>
          <p class="mb-2 text-base text-neutral-600 dark:text-neutral-200" style="font-family:  'Libre Baskerville', serif;">
